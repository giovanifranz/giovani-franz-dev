...
export function About() {
  ...
  return (
    <article className="flex w-11/12 max-w-[600px] flex-col gap-4 text-sm font-light md:w-1/2 md:text-base md:font-normal">
      <header>
      ...
      <Text>
        Atualmente sou um{' '}
        <span className="text-red">engenheiro de software full-stack</span> no{' '}
        <Link
